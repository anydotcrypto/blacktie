...
describe('BlackTie', function () {
  ...
  describe('Send ETH from inside BlackTie using default gas', function () {
  ...
  describe('Send ETH from inside BlackTie using fast gas option', function () {
    it('starts a send transaction', async function () {
      await driver.clickElement(By.xpath(`//button[contains(text(), 'Send')]`))
      await driver.delay(regularDelayMs)
  ...
  describe('Send ETH from inside BlackTie using advanced gas modal', function () {
    it('starts a send transaction', async function () {
      await driver.clickElement(By.xpath(`//button[contains(text(), 'Send')]`))
      await driver.delay(regularDelayMs)
  ...
  describe('Send ETH from dapp using advanced gas controls', function () {
    ...
    it('initiates a send from the dapp', async function () {
      ...
      windowHandles = await driver.getAllWindowHandles()
      await driver.switchToWindowWithTitle('BlackTie Notification', windowHandles)
      await driver.delay(regularDelayMs)
  ...
  describe('Send token from inside BlackTie', function () {
    let gasModal
