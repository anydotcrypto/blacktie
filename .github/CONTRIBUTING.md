...
If you're submitting code to BlackTie, there are some simple things we'd appreciate you doing to help us stay organized!
...
There are also plenty of open issues we'd love help with. Search the [`good first issue`](https://github.com/BlackTie/metamask-extension/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) label, or head to Gitcoin and earn ETH for completing projects we've posted bounties on.
...
- [ ] **Add to the CHANGELOG**: Help us keep track of all the moving pieces by adding an entry to the [`CHANGELOG.md`](https://github.com/BlackTie/metamask-extension/blob/develop/CHANGELOG.md) with a link to your PR.
